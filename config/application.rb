...
module Chatwoot
  class Application < Rails::Application
    ...
    enterprise_root = Rails.root.join('enterprise')
    if enterprise_root.directory?
      config.eager_load_paths << enterprise_root.join('lib')
      config.eager_load_paths << enterprise_root.join('listeners')
      config.eager_load_paths += Dir[Rails.root.join('enterprise/app/**')]
      config.paths['app/views'].unshift('enterprise/app/views')
      enterprise_initializers = enterprise_root.join('config/initializers')
